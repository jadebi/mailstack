...
Running on a tiny VPS (~1 vCPU, ~2 GB RAM, ~20 GB storage)? Check out the [`tiny-vps`](https://github.com/jadebi/mailstack/tree/tiny-vps) branch for resource limits tuned for that setup.
